...
}})(window);if(typeof(fodt)=="undefined"){fodt={}
...
$("textarea.gray, input.gray").focus(function(){$(this).attr("rows",7).filter(".gray").removeClass("gray").val("")
})
...
$.ajax({url:a.attr("action"),type:"POST",data:a.serialize(),beforeSend:function(){var c=a.find("div.messages");
c.empty().hide();
...
}},error:function(d,f,e){var c=a.find("div.messages");
c.empty().html("An Error Occured, Please Try Again").show();
b.onError(a,d)
}})
