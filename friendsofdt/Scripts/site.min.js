...
},useConventions:function(b,c){var a=this;
a.loadData=function(e,d){fodt.getData(b,{page:e,itemsPerPage:d},function(f){$(a.tableSelector).children("tbody").html($(c).render(f.items)).trigger("fodt.dataLoaded",[e,d,f.count])
},function(){alert("error occured")
})
};
a.onPrev=function(e,d){a.loadData(e,d)
};
a.onNext=function(e,d){a.loadData(e,d)
};
a.loadData(1,20)
